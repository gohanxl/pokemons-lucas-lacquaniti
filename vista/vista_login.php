...
function autoLogin($user, $password){
    if(login($user, $password) == $user){
        ...
        header('Location: /pokemons-lacquaniti-lucas');
    }else{
...
<head>
    ...
    <link href="/pokemons-lacquaniti-lucas/public/css/signin.css" rel="stylesheet">
...
<form class="form-signin" method="post" action="" enctype="application/x-www-form-urlencoded">
    <img class="mb-4" src="/pokemons-lacquaniti-lucas/public/img/icon-pikachu.png" width="72" height="72"/>
    <?php
    if( isset($error) ){
